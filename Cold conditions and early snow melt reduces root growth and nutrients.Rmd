...
set.seed(123)
proj_dir <- "https://github.com/anthonydn/snowmelt_belowground/blob/data/"
theme_te()
...
rall <- merge(rall, tubestats[1:40, c("Tube", "windowsto20")])
rall$sampled_volume <- rall$windowsto20/2 * 0.9 * 1.3 * 0.3
rall$root_g[rall$Type == "ERVA"] <- rall$root_area[rall$Type == "ERVA"] / 100 * 0.01009
rall$root_g[rall$Type == "NonERVA"] <- rall$root_area[rall$Type == "NonERVA"] / 100 * 0.01648
rall$root_g_m2 <- rall$root_g / rall$sampled_volume * 100 * 100 * 10
rall$Treatment <- ordered(rall$Treatment, c("CN", "AN", "CO", "AO"))
